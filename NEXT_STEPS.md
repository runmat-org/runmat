...
- Turbine mixed arithmetic/function-call coverage now uses semantic registry-backed named calls for simple scalar callbacks instead of hand-built legacy function metadata.

...
| Cell array | MATLAB container whose elements can hold independent values. RunMat uses GC-managed storage for cell contents when identity or sharing must be preserved. | [Memory Management](/docs/runtime/gc) |

...
| Status | Path | Names | GPU | Fusion | Backend | Notes |
| --- | --- | --- | --- | --- | --- | --- |
| done | `plot/core` | `plot`, `plotyy`, `scatter`, `scatterplot`, `semilogx`, `semilogy`, `loglog`, `bar`, `area`, `histogram`, `hist`, `stairs`, `stem`, `errorbar`, `quiver`, `patch`, `pie`, `subplot`, `figure`, `groot`, `gcf`, `gca`, `axes`, `hold`, `clf`, `cla`, `drawnow`, `print`, `get`, `set`, `isgraphics`, `ishandle`, `title`, `subtitle`, `sgtitle`, `suptitle`, `xlabel`, `ylabel`, `zlabel`, `legend`, `xlim`, `ylim`, `zlim`, `xticks`, `yticks`, `xticklabels`, `yticklabels`, `xtickformat`, `ytickformat`, `xscale`, `yscale`, `linkaxes`, `zoom`, `axis`, `caxis`, `clim`, `xline`, `yline`, `text`, `grid`, `box`, `colormap`, `colororder`, `shading`, `colorbar` | host | - | - | Feature-gated through `plot-core` and backed by `runmat-plot`. |

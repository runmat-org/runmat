...
* Changed automatic GPU offload to use side-effect-free provider capability and representation feasibility checks before execution, with structured rejections and bounded correlated placement diagnostics for candidate, selection, transfer, completion, and fallback behavior; added deterministic pure-region discovery with liveness and future-consumer analysis, carrying stable region identities through bytecode, portable executable products, and Native IR.

...
const productRows: ProductRow[] = [
  ...
  ["Cloud storage", "x", "100 MB (Hobby); 10 GB (Pro); 100 GB (Team)", "Included", "Cloud storage is shared across your organization. Hobby: 100 MB (hard cap). Pro: 10 GB included, pay-as-you-go at $0.15/GB after. Team: 100 GB included, pay-as-you-go at $0.15/GB after. Version history counts toward storage.", "compare-storage"],

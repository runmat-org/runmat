...
export const metadata: Metadata = {
  title: 'MATLAB language functions',
  ...
  alternates: { canonical: '/docs/elements-of-matlab' },
};
...
export default async function ElementsOfMatlabPage() {
  ...
  return (
    <>
      <div className="mb-8">
        <h1 className="text-3xl md:text-4xl font-bold mb-2">MATLAB language functions</h1>

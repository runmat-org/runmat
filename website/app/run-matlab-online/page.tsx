...
export const metadata: Metadata = {
  ...
  alternates: { canonical: "https://runmat.com/run-matlab-online" },
};
...
const jsonLd = {
  ...
  "@graph": [
    ...
    {
      "@type": "WebPage",
      "@id": "https://runmat.com/run-matlab-online#webpage",
      url: "https://runmat.com/run-matlab-online",
      name: "Free Online MATLAB Alternative with GPU Acceleration",
      description:
        "Run MATLAB-style code online with RunMat. Browser-native execution, GPU acceleration, and no license required. Try the sandbox in seconds.",
      inLanguage: "en",
      isPartOf: { "@id": "https://runmat.com/#website" },
      breadcrumb: { "@id": "https://runmat.com/run-matlab-online#breadcrumb" },
      author: { "@id": "https://runmat.com/#organization" },
      publisher: { "@id": "https://runmat.com/#organization" },
      mainEntity: [
        { "@id": "https://runmat.com/run-matlab-online#faq" },
        { "@id": "https://runmat.com/run-matlab-online#howto" },
        { "@id": "https://runmat.com/run-matlab-online#software" },
      ],
    },
    {
      "@type": "BreadcrumbList",
      "@id": "https://runmat.com/run-matlab-online#breadcrumb",
      itemListElement: [
        { "@type": "ListItem", position: 1, name: "Home", item: "https://runmat.com" },
        {
          ...
          position: 2,
          name: "MATLAB Online",
          item: "https://runmat.com/run-matlab-online",
        },
      ],
    },
    {
      ...
      author: { "@id": "https://runmat.com/#organization" },
      publisher: { "@id": "https://runmat.com/#organization" },
      mainEntityOfPage: { "@id": "https://runmat.com/run-matlab-online#webpage" },
    },
    {
      "@type": "FAQPage",
      "@id": "https://runmat.com/run-matlab-online#faq",

    ...
    - "@type": "FAQPage"
      mainEntity:
        ...
        - "@type": "Question"
          ...
          acceptedAnswer:
            "@type": "Answer"
            text: "Yes. Both the open-source runtime and RunMat Enterprise are designed for air-gapped deployment. The runtime is a single binary you can carry in on approved media. RunMat Enterprise runs from a single server binary with local Postgres and blob storage."
        - "@type": "Question"

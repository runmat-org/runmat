...
use rustmat_hir::{HirExpr, HirExprKind, HirProgram, HirStmt, VarId};
        ...
        match &expr.kind {
            ...
            HirExprKind::Binary(a, op, b) => {
                ...
                match op {
                    ...
                    rustmat_parser::BinOp::Equal => self.emit(Instr::Equal),
                    rustmat_parser::BinOp::NotEqual => self.emit(Instr::NotEqual),
                    rustmat_parser::BinOp::Less => self.emit(Instr::Less),
                    rustmat_parser::BinOp::LessEqual => self.emit(Instr::LessEqual),
                    rustmat_parser::BinOp::Greater => self.emit(Instr::Greater),
                    rustmat_parser::BinOp::GreaterEqual => self.emit(Instr::GreaterEqual),

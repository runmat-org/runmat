...
pub use source::{
    ...
    validate_registry_acquisition, validate_server_project_acquisition, BuildProvenance,
    DiscoverSourceSymbolsError, DiscoveredSourceSymbols, FrozenProject, FrozenProjectError,
    FrozenProjectHandoff, FrozenProjectHandoffError, FrozenSourceDescriptor, GitAcquisitionIntent,
    GitAcquisitionPlan, GitAcquisitionPolicy, GitLockAction, GitPackageMount, GitPackageProvider,
    GitPolicyError, PackageMount, PackageSourceCatalog, PackageSourceProvider, PackageTrustTier,
    ProjectResolveError, ProjectResolveOptions, ProjectRevision, ProjectSymbolDefinition,
    ...
    VendoredPackage, VisibleProjectSource, WrapperProvenance,
    FROZEN_PROJECT_HANDOFF_SCHEMA_VERSION, RELEASE_SUPPLY_CHAIN_SCHEMA_VERSION,

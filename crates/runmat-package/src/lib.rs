...
pub use source::{
    ...
    plan_git_acquisition, plan_server_project_acquisition, resolve_project_async,
    source_symbols_from_frozen, source_symbols_from_index, validate_git_acquisition,
    validate_server_project_acquisition, DiscoverSourceSymbolsError, DiscoveredSourceSymbols,
    FrozenProject, FrozenProjectError, FrozenProjectHandoff, FrozenProjectHandoffError,
    FrozenSourceDescriptor, GitAcquisitionIntent, GitAcquisitionPlan, GitAcquisitionPolicy,
    GitLockAction, GitPackageMount, GitPackageProvider, GitPolicyError, PackageMount,
    PackageSourceCatalog, PackageSourceProvider, ProjectResolveError, ProjectResolveOptions,
    ProjectRevision, ProjectSymbolDefinition, ResolvedProject, ServerPolicyError,
    ServerProjectAcquisitionPlan, ServerProjectPackageMount, ServerSnapshotSelector,
    SourceAcquisitionIntent, SourceAcquisitionPolicy, SourceCatalog, SourceInventory,
    SourceInventoryEntry, SourceLockAction, StableSourceId, VendorManifest, VendoredPackage,
    VisibleProjectSource, FROZEN_PROJECT_HANDOFF_SCHEMA_VERSION, SOURCE_INVENTORY_SCHEMA_VERSION,

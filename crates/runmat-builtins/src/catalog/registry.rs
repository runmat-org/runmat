use super::{
    definitions::{
        ABS_CATALOG_ENTRY, FEVAL_CATALOG_ENTRY, FULL_CATALOG_ENTRY, GATHER_CATALOG_ENTRY,
        STRUCT_CATALOG_ENTRY, ZEROS_CATALOG_ENTRY,
    },
    BuiltinCatalogEntry,
};

static CATALOG_ENTRIES: [&BuiltinCatalogEntry; 6] = [
    &ABS_CATALOG_ENTRY,
    &FEVAL_CATALOG_ENTRY,
    &FULL_CATALOG_ENTRY,

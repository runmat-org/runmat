...
Function argument sizes, defaults, and validator declarations are part of the dependency-neutral declaration vocabulary. HIR attaches them to semantic bindings, bytecode attaches them to VM slots, and Native IR attaches them to native locals; none of those layers defines a second validator enum or default-value representation.

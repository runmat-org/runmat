...
fn test_lz4_compression_roundtrip() {
    ...
    let test_data = b"Hello, World! This is a test string that should compress reasonably well with LZ4.".repeat(10);
...
fn test_zstd_compression_roundtrip() {
    ...
    let test_data = b"This is a longer test string that should compress well with ZSTD compression algorithm. ".repeat(20);
    
    // Force ZSTD compression
    let result = engine.compress_with_algorithm(
        &test_data,

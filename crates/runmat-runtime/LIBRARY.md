...
|     ✅     | array/shape         | reshape, squeeze, permute, ipermute, repmat, repelem, kron, cat, horzcat, vertcat, flip, fliplr, flipud, rot90, circshift, tril, triu, diag | Layout transforms               | ✓   | T      | BLAS (for kron via GEMM blocks) | Device-side index kernels; fuse where possible.                                          |
...
|     ✅     | math/elementwise    |  single, double, uint16                                                        | Numeric casting (array/scalar) | ✓   | E      | —                | `single`/`double` preserve floating dtype semantics; `uint16` applies MATLAB-style saturating rounding. |
...
|     ✅     | io/filetext  | fileread, filewrite, fopen, fclose, fread, fwrite, feof, fgetl, fgets, fprintf                       | Text/binary I/O        | —   | —      | —                |                                            |

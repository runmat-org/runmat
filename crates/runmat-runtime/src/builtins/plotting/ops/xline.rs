...
fn visible_from_numeric_scalar(value: NumericScalar) -> Option<bool> {
    match value {
        NumericScalar::F64(value) if value == 0.0 => Some(false),
        NumericScalar::F64(value) if value == 1.0 => Some(true),
        NumericScalar::F32(value) if value == 0.0 => Some(false),
        NumericScalar::F32(value) if value == 1.0 => Some(true),

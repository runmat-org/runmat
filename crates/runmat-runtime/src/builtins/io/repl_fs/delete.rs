...
fn exact_zero_one(value: &Value) -> BuiltinResult<bool> {
    ...
    match numeric {
        NumericScalar::F64(value) if value == 0.0 => Ok(false),
        NumericScalar::F64(value) if value == 1.0 => Ok(true),
        NumericScalar::F32(value) if value == 0.0 => Ok(false),
        NumericScalar::F32(value) if value == 1.0 => Ok(true),

...
use metadata::*;
pub use metadata::{
    DETECT_IMPORT_OPTIONS_DESCRIPTOR, FUSION_SPEC, GPU_SPEC, GROUPSUMMARY_DESCRIPTOR,
    HEIGHT_DESCRIPTOR, READTABLE_DESCRIPTOR, SPREADSHEET_IMPORT_OPTIONS_DESCRIPTOR,
    TABLE_COMPAT_DESCRIPTOR, TABLE_DESCRIPTOR, TABLE_PREDICATE_DESCRIPTOR,
    TABLE_SUBSASGN_DESCRIPTOR, TABLE_SUBSREF_DESCRIPTOR, TABLE_VARIADIC_DESCRIPTOR,
    TABLE_WRITE_DESCRIPTOR, WIDTH_DESCRIPTOR,
};

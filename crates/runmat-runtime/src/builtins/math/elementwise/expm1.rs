...
fn promote_integer_storage_to_expm1_domain(storage: NumericStorage) -> Vec<f64> {
    storage
...
pub(crate) mod tests {
    ...
    #[test]
    fn expm1_integer_gpu_promotes_after_exact_gather_and_returns_floating_storage() {
        test_support::with_test_provider(|provider| {
            ...
            assert_eq!(
                ...
                NumericStorage::F64(vec![0.0, f64::INFINITY])
            );
        });
    }

...
use runmat_value::{
    ComplexStorage, ComplexTensor, IntValue, IntegerComplexStorage, IntegerStorage, LogicalArray,
    ...
    match value {
        ...
        Value::ComplexTensor(tensor) => Ok((
            match tensor.numeric_dtype() {
                runmat_value::NumericDType::F64 => TargetClass::F64,
                runmat_value::NumericDType::F32 => TargetClass::F32,
                runmat_value::NumericDType::I8 => TargetClass::I8,
                runmat_value::NumericDType::I16 => TargetClass::I16,
                runmat_value::NumericDType::I32 => TargetClass::I32,
                runmat_value::NumericDType::I64 => TargetClass::I64,
                runmat_value::NumericDType::U8 => TargetClass::U8,
                runmat_value::NumericDType::U16 => TargetClass::U16,
                runmat_value::NumericDType::U32 => TargetClass::U32,
                runmat_value::NumericDType::U64 => TargetClass::U64,
            },
            true,
        )),

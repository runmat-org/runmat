...
#[cfg_attr(feature = "doc_export", runmat_macros::register_doc_text(name = "max"))]
...
## See Also
[min](./min), [sum](./sum), [mean](./mean), [gpuArray](../../acceleration/gpu/gpuArray), [gather](../../acceleration/gpu/gather)

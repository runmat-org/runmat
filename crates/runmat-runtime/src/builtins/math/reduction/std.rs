...
fn std_gpu(handle: GpuTensorHandle, args: &ParsedArguments) -> BuiltinResult<Value> {
...
fn std_gpu_fallback(handle: &GpuTensorHandle, args: &ParsedArguments) -> BuiltinResult<Value> {

...
pub const GPU_SPEC: BuiltinGpuSpec = BuiltinGpuSpec {
    ...
    notes: "Real GPU inputs route through provider `trapz_dim` for unit, scalar, vector, and tensor spacing; complex/provider-missing cases fall back to host semantics.",
};

...
keywords: ["lu", "factorization", "decomposition", "lower-upper", "permutation"]
...
fn lu_error(message: impl Into<String>) -> RuntimeControlFlow {
...
fn with_lu_context(flow: RuntimeControlFlow) -> RuntimeControlFlow {
    match flow {

    ...
    match value {
        ...
        Value::Int(value) => {
            let storage = match value {
                IntValue::I8(value) => runmat_builtins::IntegerStorage::I8(vec![*value]),
                IntValue::I16(value) => runmat_builtins::IntegerStorage::I16(vec![*value]),
                IntValue::I32(value) => runmat_builtins::IntegerStorage::I32(vec![*value]),
                IntValue::I64(value) => runmat_builtins::IntegerStorage::I64(vec![*value]),
                IntValue::U8(value) => runmat_builtins::IntegerStorage::U8(vec![*value]),
                IntValue::U16(value) => runmat_builtins::IntegerStorage::U16(vec![*value]),
                IntValue::U32(value) => runmat_builtins::IntegerStorage::U32(vec![*value]),
                IntValue::U64(value) => runmat_builtins::IntegerStorage::U64(vec![*value]),
            };

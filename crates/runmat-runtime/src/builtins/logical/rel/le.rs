...
#[cfg_attr(
    feature = "doc_export",
    runmat_macros::register_doc_text(name = "le", wasm_path = "crate::builtins::logical::rel::le")
)]
...
#[runmat_macros::register_gpu_spec(wasm_path = "crate::builtins::logical::rel::le")]
...
#[runmat_macros::register_fusion_spec(wasm_path = "crate::builtins::logical::rel::le")]
...
#[runtime_builtin(
    ...
    accel = "elementwise",
    wasm_path = "crate::builtins::logical::rel::le"
)]

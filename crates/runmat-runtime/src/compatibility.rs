...
/// Seed a standalone runtime context from the legacy thread-local extension
/// policy before entering that context's scope.
pub fn inherit_legacy_extension_policy(context: &crate::context::RuntimeContext) {
    let enabled = RUNMAT_EXTENSIONS_ENABLED.with(Cell::get);
    context.state().runmat_extensions_enabled.set(enabled);
}
...
mod tests {
    ...
    fn integer_extensions_are_declared_in_builtin_metadata() {
        ...
        let catalog_extensions =
            runmat_builtins::builtin_catalog_entries()
                .iter()
                .flat_map(|entry| {
                    entry
                        .extensions
                        .iter()
                        .map(move |extension| (entry.identity.name, extension.id))
                });
        ...
        let expected = std::collections::BTreeSet::from([
            ...
            ("bitcmp", "direct-bit-gpu-assumedtype"),
            ("bitcmp", "direct-bit-gpu-undocumented-input"),
            ("bitget", "direct-bit-gpu-assumedtype"),
            ("bitget", "direct-bit-gpu-undocumented-input"),
            ("bitset", "direct-bit-gpu-assumedtype"),
            ("bitset", "direct-bit-gpu-undocumented-input"),
            ("bitxor", "bitxor-gpu-assumedtype"),
            ("bitxor", "bitxor-gpu-undocumented-input"),
            ("bitxor", "bitxor-single-input"),
            ...
            ("stackedplot", "stackedplot-explicit-gpu-input"),
            ...
            (
                "standardizeMissing",
                "standardize-missing-explicit-gpu-indicator",
            ),
            ("standardizeMissing", "standardize-missing-integer-data"),
            ("statset", "statset-integer-option-value"),
            ("step", "step-integer-time"),
            ("stepinfo", "stepinfo-integer-sampled-data"),
            ("stepinfo", "stepinfo-integer-threshold"),
            (
            ...
            ("regress", "regress-integer-alpha"),
            ("regress", "regress-integer-data"),
            ("resample", "resample-integer-options"),
            ("ridge", "ridge-integer-data"),
            ("ridge", "ridge-integer-k"),
            ("ridge", "ridge-integer-scaled"),
            ("rlocus", "rlocus-integer-gain"),
            ("rmmissing", "rmmissing-integer-dimension"),
            ("roots", "roots-integer-coefficients"),
            ("rot90", "rot90-direction-token"),
            ("round", "round-typed-integer-digits"),
            ("rref", "rref-integer-matrix"),
            ("rref", "rref-integer-tolerance"),
            ("scatterhist", "scatterhist-gpu-input"),
            ("scatterhist", "scatterhist-integer-data"),
            ("scatterhist", "scatterhist-integer-group"),
            ("scatterhist", "scatterhist-integer-option"),
            ("scatterplot", "scatterplot-integer-control"),
            ("scatterplot", "scatterplot-integer-data"),
            ("limit", "limit-numeric-expression"),
            ("rng", "rng-typed-state-fields"),
            ("rng", "rng-wide-seed"),
            ("sin", "sin-character-input"),
            ("sin", "sin-integer-input"),
            ("sin", "sin-like-output"),
            ("sin", "sin-logical-input"),
            ("sind", "sind-integer-input"),
            ("sind", "sind-logical-input"),
            ("single", "single-like-output"),
            ("sinh", "sinh-character-input"),
            ("sinh", "sinh-integer-input"),
            ("sinh", "sinh-logical-input"),
            ("sinpi", "sinpi-character-input"),
            ("sinpi", "sinpi-integer-input"),
            ("sinpi", "sinpi-logical-input"),
            ("spdiags", "spdiags-integer-control"),
            ("spdiags", "spdiags-integer-data"),
            ("spectrogram", "spectrogram-integer-numeric-control"),
            ("spectrogram", "spectrogram-integer-signal"),
            ("sphere", "sphere-typed-face-count"),
            ("spline", "spline-integer-query-points"),
            ("spline", "spline-integer-sample-locations"),
            ("spline", "spline-integer-sample-values"),
            ("splitapply", "splitapply-integer-group-vector"),
            ("spones", "spones-integer-input"),
            ("sprand", "sprand-integer-numeric-control"),
            ("sqrt", "sqrt-integer-input"),
            ("squareform", "squareform-explicit-gpu-input"),
            ("squareform", "squareform-integer-input"),
            ...
            ("readtimetable", "table2timetable-numeric-row-times"),
            (
                "spreadsheetImportOptions",
                "spreadsheetimportoptions-typed-integer-location-control",
            ),
            ...
            ("string", "string-explicit-gpu-input"),
            ("string", "string-format-spec"),
            ("strings", "strings-fill-mode"),
            ("strings", "strings-like-prototype"),
            ("subplot", "subplot-integer-grid-control"),
            ("subtitle", "subtitle-integer-axes-handle"),
            ("svd", "svd-integer-input"),
            ("svd", "svd-integer-option"),
            ("svd", "svd-logical-input"),
            ("svd", "svd-logical-option"),
            ("swapbytes", "swapbytes-explicit-gpu-input"),
            ("table", "table-gpu-input"),
            ("table2struct", "table2struct-integer-toscalar"),
            ("table2timetable", "table2timetable-generated-row-times"),
            ("table2timetable", "table2timetable-gpu-input"),
            ("table2timetable", "table2timetable-numeric-row-times"),
            ("tan", "tan-character-input"),
            ("tan", "tan-integer-input"),
            ("tan", "tan-like-output"),
            ("tan", "tan-logical-input"),
            ("tand", "tand-character-input"),
            ("tand", "tand-integer-input"),
            ("tand", "tand-logical-input"),
            ("tanh", "tanh-character-input"),
            ("tanh", "tanh-integer-input"),
            ("tanh", "tanh-logical-input"),
            ("tcdf", "tcdf-integer-degrees-of-freedom"),
            ("tcdf", "tcdf-integer-x"),
            ("tcdf", "tcdf-logical-input"),
            ("tcpclient", "tcpclient-explicit-gpu-input"),
            ("tcpclient", "tcpclient-integer-connect-timeout"),
            ("tcpclient", "tcpclient-integer-port"),
            ("tcpclient", "tcpclient-integer-timeout"),
            ("tcpclient", "tcpclient-legacy-constructor-options"),
            ("tcpclient", "tcpclient-zero-port"),
            ("tcpserver", "tcpserver-explicit-gpu-input"),
            ("tcpserver", "tcpserver-integer-port"),
            ("tcpserver", "tcpserver-integer-timeout"),
            ("tcpserver", "tcpserver-legacy-constructor-options"),
            ("tcpserver", "tcpserver-zero-port"),
            ("test", "cvpartition-test-integer-index"),
            ("test", "cvpartition-test-logical-index"),
            ("text", "text-explicit-gpu-input"),
            ("text", "text-integer-axes-handle"),
            ("textscatter", "textscatter-explicit-gpu-input"),
            ("textscatter", "textscatter-integer-axes-handle"),
            ("textscatter3", "textscatter3-explicit-gpu-input"),
            ("textscatter3", "textscatter3-integer-axes-handle"),
            ("tf", "tf-default-discrete-sample-time"),
            ("tf", "tf-explicit-gpu-input"),
            ("tf", "tf-integer-coefficients"),
            ("tf", "tf-integer-sample-time"),
            ("tf", "tf-logical-coefficients"),
            ("tf", "tf-variable-shorthand-alias"),
            ("timeit", "timeit-explicit-gpu-num-outputs"),
            ("timeit", "timeit-typed-integer-num-outputs"),
            ("timer", "timer-explicit-gpu-numeric-property"),
            ("timerange", "timerange-explicit-gpu-input"),
            ("timerange", "timerange-numeric-bounds"),
            ("timerfind", "timerfind-explicit-gpu-numeric-filter"),
            ("timerfindall", "timerfind-explicit-gpu-numeric-filter"),
            ("timetable", "timetable-explicit-gpu-input"),
            ("timetable", "timetable-generated-row-times"),
            ("timetable", "timetable-numeric-row-times"),
            ("timetable2table", "timetable2table-explicit-gpu-input"),
            (
                "timetable2table",
                "timetable2table-typed-integer-convert-row-times",
            ),
            ("tinv", "tinv-integer-degrees-of-freedom"),
            ("tinv", "tinv-integer-probability"),
            ("tinv", "tinv-logical-input"),
            ("toc", "toc-legacy-double-timer-handle"),
            ("toeplitz", "toeplitz-complex-integer-input"),
            ("tpdf", "tpdf-integer-degrees-of-freedom"),
            ("tpdf", "tpdf-integer-x"),
            ("tpdf", "tpdf-logical-input"),
            ("trace", "trace-character-input"),
            ("trace", "trace-integer-input"),
            ("trace", "trace-logical-input"),
            (
                "trainWordEmbedding",
                "train-word-embedding-native-integer-controls",
            ),
            ("training", "cvpartition-training-integer-index"),
            ("training", "cvpartition-training-logical-index"),
            ("uitable", "uitable-explicit-gpu-data"),
            ("unidrnd", "unidrnd-integer-limit"),
            ("unidrnd", "unidrnd-integer-size"),
            ("unifrnd", "unifrnd-integer-lower-bound"),
            ("unifrnd", "unifrnd-integer-size"),
            ("unifrnd", "unifrnd-integer-upper-bound"),
            ("unwrap", "unwrap-integer-phase-data"),
            ("unwrap", "unwrap-integer-tolerance"),
            ("unwrap", "unwrap-logical-phase-data"),

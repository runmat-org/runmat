...
fn format_long_command_syntax_produces_string_arg() {
    ...
    match &program.body[0] {
        ...
        other => panic!("expected ExprStmt(CommandCall), got {other:?}"),
    }
}
...
fn format_all_numeric_modes_parse() {
    ...
    for mode in &[
        ...
        match &program.body[0] {
            ...
            other => panic!("format {mode}: expected CommandCall, got {other:?}"),
        }
    }
}
...
fn format_long_newline_pi_is_two_statements_not_two_args() {
    ...
    match &program.body[0] {
        ...
        other => panic!("statement 0: expected format CommandCall, got {other:?}"),
    }

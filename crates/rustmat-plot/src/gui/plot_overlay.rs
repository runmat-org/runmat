...
use crate::core::{PlotRenderer, plot_utils};
use crate::styling::{PlotThemeConfig, ModernDarkTheme};
use egui::{Context, Rect, Color32, Stroke, Pos2, Align2, FontId};
...
impl PlotOverlay {
    ...
    fn render_plot_area(
        ...
        let plot_rect = Rect::from_min_size(
            ...
            available_rect.size() - egui::Vec2::new(
        ...
        let centered_plot_rect = Rect::from_center_size(
            plot_rect.center(),

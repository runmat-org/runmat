...
<head>
    ...
    <title>RustMat Interactive Plot</title>
</head>
<body>
    <div id="rustmat-container-{}" style="width: {}px; height: {}px; border: 1px solid #ddd;">
        <canvas id="rustmat-canvas-{}" width="{}" height="{}"></canvas>
        <div style="position: absolute; top: 10px; right: 10px;">
            <button onclick="alert('RustMat Interactive Plot')">Info</button>
        </div>
    </div>
    
    <script>
        console.log('RustMat interactive widget placeholder initialized');
        const canvas = document.getElementById('rustmat-canvas-{}');
        ...
        ctx.fillText('RustMat Interactive Plot', canvas.width/2, canvas.height/2 - 10);

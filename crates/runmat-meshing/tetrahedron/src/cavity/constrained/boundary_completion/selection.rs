...
pub(in super::super) fn best_boundary_face_completion_tetrahedron_for_faces(
    faces: &[[u32; 3]],
...
pub(in super::super) fn best_boundary_face_split_completion_for_faces(
    faces: &[[u32; 3]],
    cavity: &ConstrainedCavity,
    boundary_nodes: &BTreeMap<u32, Point3>,
    boundary_triangles: &[Triangle3],
...
pub(in super::super) fn best_boundary_face_edge_split_completion_for_faces(
    faces: &[[u32; 3]],
    cavity: &ConstrainedCavity,
    boundary_nodes: &BTreeMap<u32, Point3>,
    boundary_triangles: &[Triangle3],
...
pub(in super::super) fn best_boundary_face_three_edge_split_completion_for_faces(
    faces: &[[u32; 3]],
    cavity: &ConstrainedCavity,
    boundary_nodes: &BTreeMap<u32, Point3>,
    boundary_triangles: &[Triangle3],

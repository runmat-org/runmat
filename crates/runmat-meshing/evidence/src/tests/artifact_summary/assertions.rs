...
pub(super) fn assert_tetrahedron_recovery_evidence(recovery: &MeshTetrahedronRecoveryEvidence) {
    ...
    assert_eq!(
        recovery.post_repair_attempted_source_edge_split_refill_item_count,
        1
    );
    assert_eq!(
        recovery.post_repair_attempted_cad_curve_source_edge_split_refill_item_count,
        1
    );
    ...
    assert_eq!(
        recovery.post_repair_rejected_source_edge_split_refill_item_count,
        0
    );
    assert_eq!(
        recovery.post_repair_rejected_cad_curve_source_edge_split_refill_item_count,
        0
    );
    ...
    assert_eq!(
        recovery.attempted_cad_curve_absent_source_edge_recovery_item_count,
        1
    );
    assert_eq!(
    ...
    assert_eq!(
        recovery.reconnected_cad_curve_absent_source_edge_recovery_item_count,
        1
    );
    assert_eq!(recovery.rejected_absent_source_edge_recovery_item_count, 0);
    assert_eq!(
        recovery.rejected_cad_curve_absent_source_edge_recovery_item_count,
        0
    );
    ...
    assert_eq!(
        recovery.recovered_boundary_owned_material_interface_recovery_item_count,
        1
    );
    assert_eq!(recovery.interior_material_interface_recovery_item_count, 1);
    assert_eq!(
        recovery.recovered_interior_face_material_interface_recovery_item_count,
        1
    );
    assert_eq!(
        recovery.recovered_absent_partition_material_interface_recovery_item_count,
        1
    );
    assert_eq!(
    ...
    assert_eq!(
        recovery.optimization_interior_smoothing_budget_limited_count,
        1
    );
    assert_eq!(

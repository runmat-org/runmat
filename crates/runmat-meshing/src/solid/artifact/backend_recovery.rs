...
use runmat_meshing_tetrahedron::recover::{TetrahedronRecoveryKind, TetrahedronRecoveryQueue};

use super::backend_counts::{bounded_missing_recovery_ids, recovery_entity_count};

pub(super) fn recovery_summary(
    ...
    MeshBackendSummary {
        ...
        tetrahedron_recovery_item_count: recovery_entity_count(recovery_queue, "recovery_items"),
        tetrahedron_recovered_item_count: recovery_entity_count(recovery_queue, "recovered_items"),
        ...
        tetrahedron_recovered_volume_edge_source_edge_recovery_item_count:
            recovery_entity_count(recovery_queue, "recovered_volume_edge_source_edge_items"),
        ...
        tetrahedron_recovered_boundary_edge_source_edge_recovery_item_count:
            recovery_entity_count(recovery_queue, "recovered_boundary_edge_source_edge_items"),
        ...
        tetrahedron_recovered_interior_edge_source_edge_recovery_item_count:
            recovery_entity_count(recovery_queue, "recovered_interior_edge_source_edge_items"),
        tetrahedron_cad_curve_interior_edge_source_edge_recovery_item_count:
            recovery_entity_count(recovery_queue, "cad_curve_interior_edge_source_edge_recovery_items"),
        ...
        tetrahedron_recovered_absent_edge_source_edge_recovery_item_count:
            recovery_entity_count(recovery_queue, "recovered_absent_edge_source_edge_items"),
        ...
        tetrahedron_recovered_boundary_face_source_face_recovery_item_count:
            recovery_entity_count(recovery_queue, "recovered_boundary_face_source_face_items"),
        ...
        tetrahedron_recovered_interior_face_source_face_recovery_item_count:
            recovery_entity_count(recovery_queue, "recovered_interior_face_source_face_items"),
        ...
        tetrahedron_recovered_volume_face_source_face_recovery_item_count:
            recovery_entity_count(recovery_queue, "recovered_volume_face_source_face_items"),
        ...
        tetrahedron_recovered_absent_face_source_face_recovery_item_count:
            recovery_entity_count(recovery_queue, "recovered_absent_face_source_face_items"),
        ...
        tetrahedron_reconnected_cad_curve_absent_source_edge_recovery_item_count:
            recovery_entity_count(recovery_queue, "reconnected_cad_curve_absent_source_edge_items"),
        ...
        tetrahedron_rejected_cad_curve_absent_source_edge_recovery_item_count:
            recovery_entity_count(recovery_queue, "rejected_cad_curve_absent_source_edge_recovery_items"),
        ...
        tetrahedron_rejected_boundary_leak_material_region_mismatch_count:
            recovery_entity_count(recovery_queue, "rejected_boundary_leak_material_region_mismatch"),
        ...
        tetrahedron_boundary_owned_material_interface_recovery_item_count:
            recovery_entity_count(recovery_queue, "boundary_owned_material_interface_recovery_items"),
        tetrahedron_recovered_boundary_owned_material_interface_recovery_item_count:
            recovery_entity_count(recovery_queue, "recovered_boundary_owned_material_interface_items"),
        ...
        tetrahedron_rejected_absent_material_partition_facet_topology_count:
            recovery_entity_count(recovery_queue, "rejected_absent_material_partition_facet_topology"),
        tetrahedron_rejected_absent_material_partition_element_exists_count:
            recovery_entity_count(recovery_queue, "rejected_absent_material_partition_element_exists"),
        ...
        tetrahedron_rejected_absent_material_partition_quality_gate_count:
            recovery_entity_count(recovery_queue, "rejected_absent_material_partition_quality_gate"),
        ...
        tetrahedron_omitted_missing_source_face_recovery_id_count:
            missing_source_face_recovery.omitted_count,
        ...
        tetrahedron_omitted_missing_source_edge_recovery_id_count:
            missing_source_edge_recovery.omitted_count,
        tetrahedron_cad_curve_source_edge_recovery_item_count: recovery_entity_count(
            recovery_queue,
            "cad_curve_source_edge_items",
        ),
        tetrahedron_recovered_cad_curve_source_edge_recovery_item_count: recovery_entity_count(
            recovery_queue,
            "recovered_cad_curve_source_edge_items",
        ),
        ...
        tetrahedron_missing_material_interface_boundary_owned_recovery_item_count:
            recovery_entity_count(recovery_queue, "missing_material_interface_boundary_owned_items"),
        tetrahedron_missing_material_interface_interior_face_recovery_item_count:
            recovery_entity_count(recovery_queue, "missing_material_interface_interior_face_items"),

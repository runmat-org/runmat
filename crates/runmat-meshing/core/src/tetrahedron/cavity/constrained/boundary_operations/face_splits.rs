...
pub(in super::super) fn split_child_boundary_face(
...
pub(in super::super) fn three_edge_split_child_boundary_face(
    parent: &ConstrainedCavityBoundaryFace,
    node_ids: [u32; 3],
    perimeter_source_edges: &BTreeMap<[u32; 2], Option<u32>>,
    edge_split_node_ids: &BTreeMap<[u32; 2], u32>,
...
pub(in super::super) fn edge_split_child_boundary_face(
    parent: &ConstrainedCavityBoundaryFace,
    node_ids: [u32; 3],
    split_node_id: u32,
    split_edge: [u32; 2],

...
pub(super) fn split_constrained_cavity_boundary_face_on_edge(
    face: &ConstrainedCavityBoundaryFace,
    edge: [u32; 2],
    split_node_id: u32,
...
pub(super) fn split_constrained_cavity_boundary_faces_on_edge(
    faces: &[ConstrainedCavityBoundaryFace],
    face_node_ids: [u32; 3],
    edge: [u32; 2],
    split_node_id: u32,
...
pub(super) fn split_constrained_cavity_boundary_faces_on_edge_patch(
    faces: &[ConstrainedCavityBoundaryFace],
    edge: [u32; 2],
    split_node_id: u32,
) -> Result<Vec<ConstrainedCavityBoundaryFace>, ConstrainedCavityBoundarySplitError> {
...
pub(super) fn split_constrained_cavity_boundary_face_on_edge_patch(
    face: &ConstrainedCavityBoundaryFace,
    split_edge: [u32; 2],
    split_node_id: u32,
) -> Result<[ConstrainedCavityBoundaryFace; 2], ConstrainedCavityBoundarySplitError> {
...
pub(super) fn split_constrained_cavity_boundary_faces_on_three_edges(
    faces: &[ConstrainedCavityBoundaryFace],
    face_node_ids: [u32; 3],
...
pub(super) fn split_constrained_cavity_boundary_face_on_three_edges(
    face: &ConstrainedCavityBoundaryFace,
    edge_split_node_ids: &BTreeMap<[u32; 2], u32>,
...
pub(super) fn split_child_boundary_face(
...
pub(super) fn three_edge_split_child_boundary_face(
    parent: &ConstrainedCavityBoundaryFace,
    node_ids: [u32; 3],
    perimeter_source_edges: &BTreeMap<[u32; 2], Option<u32>>,
    edge_split_node_ids: &BTreeMap<[u32; 2], u32>,
...
pub(super) fn edge_split_child_boundary_face(
    parent: &ConstrainedCavityBoundaryFace,
    node_ids: [u32; 3],
    split_node_id: u32,
    split_edge: [u32; 2],

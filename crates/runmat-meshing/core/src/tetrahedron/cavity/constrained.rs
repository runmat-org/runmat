...
fn complete_missing_boundary_face_tetrahedra(
    cavity: &ConstrainedCavity,
    boundary_nodes: &BTreeMap<u32, Point3>,
...
fn best_boundary_face_completion_tetrahedron_for_faces(
    faces: &[[u32; 3]],
    cavity: &ConstrainedCavity,
    boundary_nodes: &BTreeMap<u32, Point3>,
    refill_tetrahedra: &[ConstrainedCavityRefillTetrahedron],
...
fn split_completion_tetrahedra_for_node(
    face: [u32; 3],
    cap_node_id: u32,
...
fn edge_split_completion_tetrahedra_for_node(
    face: [u32; 3],
    edge: [u32; 2],
    cap_node_id: u32,
    split_node: &ConstrainedCavityNode,
...
fn three_edge_split_completion_tetrahedra_for_node(
    face: [u32; 3],
    cap_node_id: u32,
...
#[cfg(test)]
fn append_cap_side_connector_tetrahedra(
...
fn append_cap_side_connector_chain_tetrahedra(
    candidate_tetrahedra: &mut Vec<ConstrainedCavityRefillTetrahedron>,
    seen_tetrahedra: &mut BTreeSet<[u32; 4]>,
    node_points: &BTreeMap<u32, [f64; 3]>,
    inserted_node_ids: &BTreeSet<u32>,
...
fn best_boundary_face_completion_tetrahedron(
    face: [u32; 3],
    cavity: &ConstrainedCavity,
    boundary_nodes: &BTreeMap<u32, Point3>,
    refill_tetrahedra: &[ConstrainedCavityRefillTetrahedron],

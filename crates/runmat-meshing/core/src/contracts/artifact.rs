...
pub struct MeshBackendSummary {
    ...
    #[serde(default)]
    pub tet_volume_coverage_ratio: f64,
    #[serde(default)]
    ...
    #[serde(default)]
    pub tet_accepted_requested_refinement_location_count: usize,
    #[serde(default)]

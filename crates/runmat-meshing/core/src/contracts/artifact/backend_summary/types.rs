...
pub struct MeshBackendSummary {
    ...
    #[serde(default)]
    pub tetrahedron_recovered_volume_edge_source_edge_recovery_item_count: usize,
    #[serde(default)]
    pub tetrahedron_boundary_edge_source_edge_recovery_item_count: usize,
    #[serde(default)]
    pub tetrahedron_recovered_boundary_edge_source_edge_recovery_item_count: usize,
    #[serde(default)]
    ...
    #[serde(default)]
    pub tetrahedron_attempted_source_edge_split_refill_item_count: usize,
    #[serde(default)]
    pub tetrahedron_attempted_cad_curve_source_edge_split_refill_item_count: usize,
    #[serde(default)]
    pub tetrahedron_accepted_source_edge_split_refill_candidate_item_count: usize,
    #[serde(default)]
    ...
    #[serde(default)]
    pub tetrahedron_recovered_boundary_face_source_face_recovery_item_count: usize,
    #[serde(default)]
    pub tetrahedron_interior_face_source_face_recovery_item_count: usize,
    #[serde(default)]
    pub tetrahedron_recovered_interior_face_source_face_recovery_item_count: usize,
    #[serde(default)]
    pub tetrahedron_volume_face_source_face_recovery_item_count: usize,
    #[serde(default)]
    pub tetrahedron_recovered_volume_face_source_face_recovery_item_count: usize,
    #[serde(default)]
    ...
    #[serde(default)]
    pub tetrahedron_recovered_absent_face_source_face_recovery_item_count: usize,
    #[serde(default)]
    ...
    #[serde(default)]
    pub tetrahedron_attempted_cad_curve_absent_source_edge_recovery_item_count: usize,
    #[serde(default)]
    pub tetrahedron_reconnected_absent_source_edge_recovery_item_count: usize,
    #[serde(default)]
    pub tetrahedron_reconnected_cad_curve_absent_source_edge_recovery_item_count: usize,
    #[serde(default)]
    pub tetrahedron_rejected_absent_source_edge_recovery_item_count: usize,
    #[serde(default)]
    pub tetrahedron_rejected_cad_curve_absent_source_edge_recovery_item_count: usize,
    #[serde(default)]
    ...
    #[serde(default)]
    pub tetrahedron_recovered_boundary_owned_material_interface_recovery_item_count: usize,
    #[serde(default)]
    pub tetrahedron_interior_material_interface_recovery_item_count: usize,
    #[serde(default)]
    pub tetrahedron_recovered_interior_face_material_interface_recovery_item_count: usize,
    #[serde(default)]
    pub tetrahedron_recovered_absent_partition_material_interface_recovery_item_count: usize,
    #[serde(default)]
    ...
    #[serde(default)]
    pub tetrahedron_cad_curve_source_edge_recovery_item_count: usize,
    #[serde(default)]
    pub tetrahedron_recovered_cad_curve_source_edge_recovery_item_count: usize,
    #[serde(default)]
    pub tetrahedron_missing_cad_curve_source_edge_recovery_item_count: usize,
    #[serde(default)]
    pub tetrahedron_missing_cad_curve_source_edge_topology_recovery_item_count: usize,
    #[serde(default)]
    pub tetrahedron_missing_cad_curve_source_edge_provenance_recovery_item_count: usize,
    #[serde(default)]
    ...
    #[serde(default)]
    pub tetrahedron_optimization_interior_smoothing_accepted_count: usize,
    #[serde(default)]
    pub tetrahedron_optimization_interior_smoothing_rejected_count: usize,
    #[serde(default)]
    pub tetrahedron_optimization_interior_smoothing_budget_limited_count: usize,
    #[serde(default)]

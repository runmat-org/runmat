...
pub use contracts::canonical::{
    ...
    SolverMeshArtifact, SolverMeshNode, SolverMeshTopology, SolverMeshTransferMap,
    SolverNodeExactParameter, SolverTransferMethod, SolverTransferSource, SolverVolumeElement,
    StableDigest, SurfaceQualityTargets, VolumeQualityTargets,
    ANALYSIS_MESH_ARTIFACT_SCHEMA_VERSION, MESHING_DOMAIN_MODEL_SCHEMA_VERSION,
    ...
    SOLVER_MESH_TRANSFER_SCHEMA_VERSION, TETRAHEDRON_MIDSIDE_EDGE_CORNERS,
};

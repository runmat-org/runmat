...
pub use contracts::v2::{
    ...
    CanonicalEntityRangeV2, ContactPairV2, ErrorDistributionV2, FieldTopologyLocationV2,
    FieldTopologyMapV2, GeometricWitness, GeometryRevisionRef, GeometryTolerancePolicy,
    InvariantEvidenceV2, MaterialInterfaceV2, MeshElementOrderV2, MeshNeighborV2, MeshRegionV2,
    MeshingCancellationSignal, MeshingCapabilityRequirementV2, MeshingChunkDescriptorV2,
    MeshingChunkMediaTypeV2, MeshingContractError, MeshingDiagnosticEntry, MeshingDiagnosticValue,
    MeshingEvidenceV2, MeshingFailure, MeshingFailureCategory, MeshingJoinIdentityV2,
    MeshingManifestDispositionV2, MeshingOperationV2, MeshingPartitionDescriptorV2,
    MeshingPartitionIdentityV2, MeshingPartitionKindV2, MeshingPartitionResultRefV2,
    MeshingProgressV2, MeshingQualityTargetsV2, MeshingRequestV2, MeshingResourceBudgetV2,
    MeshingResourceUsageV2, MeshingStageIdentityV2, MeshingStageManifestV2,
    MeshingStageResultIdentityV2, MeshingStageResultKindV2, MeshingStageV2,
    MeshingValidationIdentityV2, MeshingWorkloadRequestV2, MeshingWorkloadResultV2,

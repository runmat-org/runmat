...
pub use contracts::canonical::{
    ...
    BoundaryFaceRole, BoundaryTriangleOrder, CacheAdmissionDecision, CancellationPolicy,
    CanonicalEntityRange, CanonicalMeshingContract, ContactPair, CurveQualityTargets, ElementOrder,

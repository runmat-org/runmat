...
pub use contracts::canonical::{
    ...
    CanonicalMeshingContract, ContactPair, CurveQualityTargets, ElementOrder, EncodedMeshingChunk,
    ErrorDistribution, FieldTopologyLocation, FieldTopologyMap, GeometricWitness,
    GeometryRevisionRef, GeometryTolerancePolicy, InvariantEvidence, MaterialInterface,
    ...
    MeshingDiagnosticEntry, MeshingDiagnosticValue, MeshingDomainModel, MeshingEvidence,
    MeshingFailure, MeshingFailureCategory, MeshingInputKind, MeshingInputRef, MeshingJoinIdentity,

...
pub use contracts::canonical::{
    ...
    SolverBoundaryEdge, SolverBoundaryFace, SolverEntityTransfer, SolverMeshArtifact,
    SolverMeshNode, SolverMeshTopology, SolverMeshTransferMap, SolverNodeExactParameter,
    SolverTransferMethod, SolverTransferSource, SolverVolumeElement, StableDigest,
    ...
    MESHING_WORKLOAD_SCHEMA_VERSION, SOLVER_MESH_TRANSFER_SCHEMA_VERSION,

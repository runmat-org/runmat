...
pub use shared::{
    ...
    encode_shared_curve_mesh, join_shared_curve_batches, shared_curve_node_id,
    shared_degenerate_curve_node_id, validate_shared_curve_geometry, CurveMetricEvaluation,
    CurveMetricField, CurveMetricQuery, CurveMetricResolutionEvidence, CurveResolutionEvidence,
    CurveResolutionPolicy, ResolvedCurveMetricField, SharedCurve, SharedCurveBatch,
    SharedCurveDiscretizationOptions, SharedCurveError, SharedCurveErrorKind, SharedCurveFaceUse,
    SharedCurveGeometryValidationReport, SharedCurveMesh, SharedCurveNode, UniformCurveMetric,

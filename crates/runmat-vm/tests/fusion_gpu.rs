...
use runmat_hir::{
    lower as lower_hir, LegacyHirProgram as HirProgram, LoweringContext, SemanticError,
};
...
#[test]
fn fused_reduction_scalar_single_report_tail_matches_expected() {
    gc_test_context(|| {
        ensure_provider_registered();
...
#[test]
fn fused_reduction_scalar_branch_report_tail_matches_expected() {
    gc_test_context(|| {
        ensure_provider_registered();

...
- Brace index helper lowering now also enforces context invariants on helper read/store-back paths (`RunMat:MirCellIndexContextInvalid`) instead of bypassing brace index result-context checks in member-chain store-back compilation.

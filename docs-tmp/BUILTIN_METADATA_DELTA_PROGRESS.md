...
| Wave 3 (Random Constructors) | `rand`, `randn`, `randi`, `randperm` | Done | _fill_ | `cargo fmt`; `cargo test -p runmat-builtins`; `cargo test -p runmat-lsp`; targeted runtime filters `rand_`, `randn_`, `randi_`, `randperm_` | Attached descriptors + LSP signature-help coverage for random constructor family |

## Remaining Work

- Total registered builtins: `568`
- Migrated with attached descriptor: `24`
- Remaining: `544`

...
- Evidence:
  ...
  - core compile source-context symbol discovery also rejects colon-style remote/virtual source names (for example `remote:main.m`) in [compile.rs](/Users/nallana/Source/runmat-acc-2/runmat/crates/runmat-core/src/session/compile.rs), with explicit integration coverage in [tests.rs](/Users/nallana/Source/runmat-acc-2/runmat/crates/runmat-core/src/tests.rs).
  ...
  - CLI bytecode symbol discovery now also rejects colon-style remote/virtual source names in [bytecode.rs](/Users/nallana/Source/runmat-acc-2/runmat/crates/runmat-cli/src/commands/bytecode.rs), with command-level coverage for this guard boundary.

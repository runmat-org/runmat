...
- Evidence:
  ...
  - VM dispatch coverage now explicitly ratchets nested-capture and provider-unavailable policy failures at the spawn boundary in [mod.rs](/Users/nallana/Source/runmat-acc-2/runmat/crates/runmat-vm/src/interpreter/dispatch/mod.rs) tests (`spawn_policy_rejects_nested_gpu_handles_in_cell_capture`, `spawn_policy_reports_provider_unavailable_for_gpu_handles`).

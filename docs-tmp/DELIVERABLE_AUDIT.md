...
- Evidence:
  ...
  - fusion snapshot emission now includes semantic candidate nodes/decisions when bytecode fusion groups are empty but MIR semantic candidate artifacts exist, and this semantic path no longer hard-requires accel graph presence in [snapshot.rs](/Users/nallana/Source/runmat-acc-2/runmat/crates/runmat-core/src/fusion/snapshot.rs).
